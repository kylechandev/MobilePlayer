...
//    private static final String TAG = "XScrollView";
    ...
    private void initWithContext(Context context) {
        ...
        mHeaderTime = mHeader.findViewById(R.id.header_hint_time);
        LinearLayout headerLayout = mLayout.findViewById(R.id.header_layout);
        ...
        LinearLayout footLayout = mLayout.findViewById(R.id.footer_layout);
